...
public class IATAAirClient {
    ...
    public static final String AIRPORT_RESOURCE_ROOT = "iataairports/de.wikipedia.org/wiki";
    public static final String AIRLINE_RESOURCE_ROOT = "iataairlines/de.wikipedia.org/wiki";
    ...
    public static void main(String[] args) throws IOException {
        ...
        IATAAirlineParser parser = new IATAAirlineParser(AIRLINE_RESOURCE_ROOT, AIRLINE_PAGE);
        parser.parse();
        IATAAirportParser parser1 = new IATAAirportParser(AIRPORT_RESOURCE_ROOT, AIRPORT_PAGE, AIRPORT_CODES_DIR);
         parser1.parse();
